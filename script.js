...
function initEventSectionCarousels() {
  ...
  eventSections.forEach((scrollContainer) => {
    const leftButton = scrollContainer.parentElement.querySelector(
      'button:has(.material-symbols-outlined:contains("chevron_left"))'
    );
    const rightButton = scrollContainer.parentElement.querySelector(
      'button:has(.material-symbols-outlined:contains("chevron_right"))'
    );
    ...
    if (isLeftChevron || isRightChevron) {
      button.addEventListener("click", (e) => {
        ...
        const scrollContainer =
          eventSection?.querySelector(".scroll-container");
...
function initScrollAnimations() {
  const animatedElements = document.querySelectorAll(
    ".stat-item, .partner-logo, .event-card, .rectangular-card"
  );
...
document
  ...
  .addEventListener("click", function () {
    ...
    // Simulate API call
    showNotification(
      "Welcome to NeoSharX! Thank you for subscribing!",
      "success"
    );
    emailInput.value = "";
  });
